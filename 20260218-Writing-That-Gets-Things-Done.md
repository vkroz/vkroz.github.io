...
Writing forces you to structure and stress-test ideas before sharing them. Verbal explanations let you skip gaps - a written document cannot hide them. Drafting even a one-pager surfaces flawed assumptions, missing data, and logical gaps that slides conceal.
Documents invite scrutiny; slides push information. A well-written document reduces back-and-forth and creates a lasting reference. Bezos: there is no way to write a narratively structured memo and not have clear thinking.

## Before You Write: Three Questions
1. Why are you writing? What specific decision or action does this document drive? If you cannot name it, you are not ready to write. 
2. Who is your audience? An engineer, a non-technical PM, and a VP each require different depth, vocabulary, and emphasis - calibrate accordingly. 
3. Why should they read it? Apply the "so what" test. If you cannot answer it, cut until you can.
...
## Appendix A: Weasel words to avoid
...
* **Migrate to Elastic Cloud** — $18K/yr, low risk. Managed service, no hardware refresh needed.
* **Refresh on-prem hardware** — $40K upfront, medium risk. Extends runway 3 years, still on us to maintain.
* **Stay on current hardware** — $0 now, high risk. EOL Aug 2026, no security patches after that.
